...
export class JogosFormDialogComponent implements OnInit {
  ...
  // form?: FormGroup;
  form = this.fb.group({
    qtdJogos: [this.QTD_JOGOS_PADRAO, [Validators.required]],
    manterJogosExistentes: [false, [Validators.required]],
  });

  constructor(private fb: FormBuilder, private dialogRef: MatDialogRef<JogosFormDialogComponent>) {}
